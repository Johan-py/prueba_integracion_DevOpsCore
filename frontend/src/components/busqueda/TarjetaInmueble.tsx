...
export const TarjetaInmueble = ({ inmueble, posicion, esRecomendadoIA }: TarjetaInmuebleProps) => {
  ...
  const ubicacionTexto =
    typeof inmueble.ubicacion === 'object' && inmueble.ubicacion !== null
      ...
      : ''
   // ✅ Verificar si la propiedad está destacada (promoted)
   // El campo promoted puede venir en inmueble.publicaciones[0]?.promoted
   const estaDestacada = inmueble.promoted === true
