  ...
  return (
    <div>
      ...
      <div className="bg-white p-6 rounded-xl shadow-md">
        ...
        {/* Contenedor de botones: Continuar y Ampliar plan */}
        <div className="flex gap-3 mt-6">
          ...
          <Link href="/cobros-suscripciones">
            <button className="bg-gradient-to-r from-black to-orange-400 text-white px-6 py-3 rounded-lg hover:from-orange-500 hover:to-orange-600 transition-all duration-300 font-semibold shadow-md hover:shadow-lg">
              Ampliar plan
            </button>
          </Link>
        </div>
